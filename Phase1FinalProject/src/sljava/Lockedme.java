...
public class Lockedme {
	...
	public static void main(String[] args)throws IOException, InterruptedException 
	{
		...
		String st;
		File mFolder =new File("E:\\GitProjects");
		mFolder.mkdir();
		String location = "E:\\GitProjects";
		
		System.out.println("*****Welcome to LockedMe Application*****");
		System.out.println("        Created by Rahul Kumar");
	    ...
	    switch(choice) {
	    case 1:
	    	File Fobj = new File("E:\\GitProjects");
	    ...
	    case 2:
		    ...
		    case 3:
		    	...
		    	st = sc.next();
		    	File fsearch = new File("E:\\GitProjects");
